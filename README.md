...
# Features
 -Text Preprocessing: Converts text to lowercase, removes punctuation and applies a negation handler.
...
# Patch 1
![Before removal of stopwords and negation](Before(stopwords).png)
![After removal of stopwords and negation](After(stopwords).png)
